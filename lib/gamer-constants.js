      ...
      plans: [
        {
          ...
          // Velocidad del plan
          speed:
            '<span class="speed-prefix">600 MBPS</span>1000 MBPS<span class="speed-suffix">Nitro (120 horas)</span>',
          // Precio promocional
          price: "S/ 129",
  ...
  MOVIE_SLIDER_5: {
    ...
    ITEMS: [
      ...
      },
      {
        ...
        // Texto en negrita
        EMPHASIS:
          "Tomamos la ruta más directa al servidor de tu juego favorito para que tengas partidas fluidas y sin interrupciones.",
        // Texto complementario
        DESCRIPTION:
      ...
      },
      {
        ...
        // Texto en negrita
        EMPHASIS:
          "Te brindamos una mejor experiencia de juego en línea sin problemas de conectividad.",
      },
    ],
  },
